...
namespace LdapClient.Common.Enums;

/// <summary>
///     The user flags supported by Active Directory
/// </summary>
internal enum UserFlag
{
    ...
    /// <summary>
    ///     This is an account for users whose primary account is in another domain. This account provides user access to this
    ///     domain, but not to any domain that trusts this domain. Also known as a local user account.
    /// </summary>
    ...
    /// <summary>
    ///     The service account (user or computer account), under which a service runs, is trusted for Kerberos delegation. Any
    ...
    /// <summary>
    ///     The user password has expired. This flag is created by the system using data from the Pwd-Last-Set attribute and
    ///     the domain policy.
    /// </summary>
